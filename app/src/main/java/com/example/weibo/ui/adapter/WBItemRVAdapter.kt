...
import com.example.weibo.ui.holder.WBItemSimpleHolder
...
class WBItemRVAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (getItemViewType(position) == last){
            ...
            if (list[position].picturesUrl.isNotEmpty()){
                ...
                holder.itemView.blog_picture_recycler_list.visibility = View.GONE
            }
        }
    }
